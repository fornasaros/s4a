---
title: "Scripts used in evaluating SERS spectra from gingival crevicular fluid (GCF)"
...
These scripts were used to process spectral data using the [hyperSpec](http://http://cbeleites.github.io/hyperSpec/) package.

Please see the vignettes for a walkthrough and more complete usage and output information.
